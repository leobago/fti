...
FC=pgfortran
export PGI=/opt/pgi
export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/opt/pgi/linux86-64/2018/lib
export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/opt/pgi/linux86-64/2018/mpi/openmpi/lib
export PATH=/opt/pgi/linux86-64/2018/bin:$PATH
export PATH=/opt/pgi/linux86-64/2018/mpi/openmpi/bin:$PATH
