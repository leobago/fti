...
function(APPEND_PROPERTY TYPE)
	...
	foreach(TARGET ${APPEND_PROPERTY_TARGETS})
		get_property(APPEND_PROPERTY_PREVIOUS_VALUE "${TYPE}" "${TARGET}"
		 PROPERTY "${APPEND_PROPERTY_PROPNAME}")
		set_property("${TYPE}" "${TARGET}" PROPERTY
		 "${APPEND_PROPERTY_PROPNAME}"
		  "${APPEND_PROPERTY_PREVIOUS_VALUE}${APPEND_PROPERTY_VALUES}")
	endforeach()
endfunction()
